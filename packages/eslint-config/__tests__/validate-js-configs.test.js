...
describe('Validate JS configs', () => {
  it('Validate yuake-fe-eslint-config', async () => {
  ...
  it('Validate yuake-fe-eslint-config/es5', async () => {
  ...
  it('Validate yuake-fe-eslint-config/vue', async () => {
  ...
  it('Validate yuake-fe-eslint-config/essential', async () => {
  ...
  it('Validate yuake-fe-eslint-config/essential/es5', async () => {
  ...
  it('Validate yuake-fe-eslint-config/essential/react', async () => {
  ...
  it('Validate yuake-fe-eslint-config/essential/vue', async () => {
  ...
  it('Validate yuake-fe-eslint-config/node', async () => {
