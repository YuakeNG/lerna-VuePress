...
`yauke-fe-lint` 是[前端编码规范工程化](https://github.com/YuakeNG/vue-lerna.github.io)的配套 Lint 工具，可以为项目一键接入规范、一键扫描和修复规范问题，保障项目的编码规范和代码质量。
...
在项目根目录执行 `yauke-fe-lint init`，即可一键接入规范，为项目安装规范 `Lint` 所需的依赖和配置。
